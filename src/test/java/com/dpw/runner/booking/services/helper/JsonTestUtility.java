package com.dpw.runner.booking.services.helper;

import com.dpw.runner.booking.services.commons.requests.ListCommonRequest;
import com.dpw.runner.booking.services.config.CustomLocalDateTimeDeserializer;
...
import com.dpw.runner.booking.services.masterDataObjects.dto.MasterListsV1;
...
public class JsonTestUtility {
    ...
    private String path = "src/test/java/com/dpw/runner/booking/services/helper/payload.json";
