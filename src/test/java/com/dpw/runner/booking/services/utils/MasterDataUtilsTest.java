...
import com.dpw.runner.booking.services.dto.response.*;
import com.dpw.runner.booking.services.dto.v1.response.*;
import com.dpw.runner.booking.services.masterDataObjects.dto.*;
import com.dpw.runner.booking.services.masterdata.dto.CarrierMasterData;
import com.dpw.runner.booking.services.adapters.impl.BillingServiceAdapter;
...
import com.dpw.runner.booking.services.commons.constants.EntityTransferConstants;
import com.dpw.runner.booking.services.config.CustomKeyGenerator;
...
import com.dpw.runner.booking.services.masterDataObjects.dto.*;
import com.dpw.runner.booking.services.masterdata.dto.MasterData;
import com.dpw.runner.booking.services.masterdata.dto.request.MasterListRequest;
import com.dpw.runner.booking.services.masterdata.dto.request.MasterListRequestV2;
import com.dpw.runner.booking.services.masterdata.enums.MasterDataType;
import com.dpw.runner.booking.services.masterdata.response.UnlocationsResponse;
...
class MasterDataUtilsTest {
    ...
    void getCarrierName() {
        ...
        when(jsonHelper.convertValueToList(any(), eq(com.dpw.runner.booking.services.masterDataObjects.dto.CarrierMasterData.class))).thenReturn(List.of(com.dpw.runner.booking.services.masterDataObjects.dto.CarrierMasterData.builder().ItemValue(mockCarrierCode).ItemDescription("APULU Carrier").build()));
        when(v1Service.fetchCarrierMasterData(any(), anyBoolean())).thenReturn(V1DataResponse.builder().build());
    ...
    void getCarrierName2() {
        var mockCarrierCode = "APLU";
        when(jsonHelper.convertValueToList(any(), eq(com.dpw.runner.booking.services.masterDataObjects.dto.CarrierMasterData.class))).thenReturn(List.of(com.dpw.runner.booking.services.masterDataObjects.dto.CarrierMasterData.builder().ItemValue(mockCarrierCode).build()));
        when(v1Service.fetchCarrierMasterData(any(), anyBoolean())).thenReturn(V1DataResponse.builder().build());
    ...
    void setMasterData10() {
        ...
        when(cacheManager.getCache(anyString())).thenReturn(cache);
        when(keyGenerator.customCacheKeyForMasterData(anyString(), anyString())).thenReturn(new StringBuilder(StringUtility.getRandomString(11)));
        when(cache.get(any())).thenReturn(() -> com.dpw.runner.booking.services.masterDataObjects.dto.CarrierMasterData.builder().ItemDescription("DPW").build());
