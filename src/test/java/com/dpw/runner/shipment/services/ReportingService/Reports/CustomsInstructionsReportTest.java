...
class CustomsInstructionsReportTest extends CommonMocks {
    ...
    private void populateModel(CustomsInstructionsModel customsInstructionsModel) {
        ...
        customsInstructionsModel.setShipmentDetails(shipmentModel);
        customsInstructionsModel.setShipmentContainers(shipmentModel.getShipmentContainersList());
    ...
    void populateDictionary() {
        ...
        populateModel(customsInstructionsModel);
        mockVessel();
        ...
        containerMap.put(NO_OF_PACKAGES, BigDecimal.TEN);
