...
class OrderManagementConfigTest {
    ...
    @Test
    void testRestTemplateForOrderManagement() throws IOException {
        RestTemplate restTemplate = orderManagementConfig.restTemplateForOrderManagement();
