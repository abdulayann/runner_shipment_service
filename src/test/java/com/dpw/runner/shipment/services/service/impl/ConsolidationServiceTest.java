...
//    @Disabled
    ...
    void testCreate_Success() throws RunnerException {
        ...
        when(packingDao.updateEntityFromConsole(any(), anyLong(), anyLong())).thenReturn(consolidationDetails.getPackingList());
        when(eventDao.updateEntityFromOtherEntity(any(), anyLong(), anyString())).thenReturn(consolidationDetails.getEventsList());
        when(referenceNumbersDao.updateEntityFromConsole(any(), anyLong(), anyLong())).thenReturn(consolidationDetails.getReferenceNumbersList());
