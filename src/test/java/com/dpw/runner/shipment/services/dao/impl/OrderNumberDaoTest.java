...
@Testcontainers
class OrderNumberDaoTest {


    @Autowired
    private OrderNumberDao dao;
    private static JsonTestUtility jsonTestUtility;
    private static OrderNumber testData;
    ...
    void setUp() {
        ...
        testData = jsonTestUtility.getTestOrderNumberDao();
    ...
    void findAll() {
        var savedEntity = dao.save(testData);
        assertNotNull(savedEntity.getId());
        Specification<OrderNumber> spec = (root, query, criteriaBuilder) -> {
            return criteriaBuilder.equal(root.get("id"), savedEntity.getId());
        };
