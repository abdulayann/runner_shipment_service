...
@Testcontainers
class CarrierDaoTest {

    @Autowired
    private ICarrierDao dao;
    private static JsonTestUtility jsonTestUtility;
    private static CarrierDetails testData;
    ...
    void setUp() {
        ...
        testData = jsonTestUtility.getTestCarrierDetails();
    ...
    void findAll() {
        var r = dao.save(testData);
        assertNotNull(r.getId());
        Specification<CarrierDetails> spec = (root, query, criteriaBuilder) -> {
    ...
    void updateEntityFromShipmentConsole() throws RunnerException {
        var r = dao.save(testData);
        assertNotNull(r.getId());
        var result = dao.updateEntityFromShipmentConsole(r);
        assertNotNull(result);
    }
}