...
class ConsolidatedPackingListReportTest {
    ...
    void populateDictionary() {
        ...
        doReturn(consolidatedPackingListModel.getConsolidationDetails().getSendingAgent()).when(jsonHelper).convertValue(eq(consolidatedPackingListModel.getConsolidationDetails().getSendingAgent()), eq(PartiesModel.class));
