...
import com.dpw.runner.booking.services.adapters.interfaces.IPlatformServiceAdapter;
import com.dpw.runner.booking.services.adapters.interfaces.IShipmentServiceAdapter;
...
import com.dpw.runner.booking.services.commons.constants.CustomerBookingConstants;
import com.dpw.runner.booking.services.commons.constants.PartiesConstants;
...
import com.dpw.runner.booking.services.dao.impl.NotesDao;
import com.dpw.runner.booking.services.dao.interfaces.ICustomerBookingDao;
...
import com.dpw.runner.booking.services.entity.enums.Status;
import com.dpw.runner.booking.services.masterDataObjects.dto.CarrierMasterData;
import com.dpw.runner.booking.services.masterDataObjects.dto.ChargeTypeMasterData;
...
import com.dpw.runner.booking.services.masterdata.factory.MasterDataFactory;
    ...
    public ShipmentDetailsResponse createShipmentInV2(CustomerBookingRequest customerBookingRequest) throws RunnerException {
        try {
            ...
            ShipmentRequest shipmentRequest = ShipmentRequest.builder().
                    ...
                    routingsList(customerBookingRequestRoutingList != null
                            ? customerBookingRequestRoutingList.stream().peek(routing -> {
