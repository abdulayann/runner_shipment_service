...
import com.dpw.runner.booking.services.utils.ExcludeTenantFilter;
...
public class TenantAspect {
    ...
    @Before("execution(* com.dpw.runner.booking.services.aspects.MultitenancyAspect.MultiTenancyRepository+.*(..))")
