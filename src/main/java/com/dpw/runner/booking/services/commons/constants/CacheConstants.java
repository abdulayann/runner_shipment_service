...
public class CacheConstants {
    ...
    public static final String CACHE_KEY = "Booking_Service";
    public static final String CACHE_KEY_USER = "Booking_Service_UserData";
    public static final String CACHE_KEY_MASTER_DATA = "Booking_Service_MasterData";
