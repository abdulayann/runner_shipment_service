package com.dpw.runner.booking.services.aspects.TimeZoneAspect;

import com.dpw.runner.booking.services.aspects.MultitenancyAspect.UserContext;
import com.dpw.runner.booking.services.commons.constants.TimeZoneConstants;
import com.dpw.runner.booking.services.dto.request.UsersDto;
import com.dpw.runner.booking.services.utils.DateUtils;
...
public class TenantTimeZoneAspect {
    ...
    @Pointcut("execution(* com.dpw.runner.booking.services.controller.*.*(..))" + "&& !@annotation(com.dpw.runner.booking.services.utils.ExcludeTimeZone)")
