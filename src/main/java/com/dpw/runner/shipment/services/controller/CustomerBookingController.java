...
public class CustomerBookingController {
    ...
    @PreAuthorize("hasAuthority('" + PermissionConstants.OPERATIONS_CUSTOMER_BOOKINGS_CREATE + "')")
    ...
    @PreAuthorize("hasAuthority('" + PermissionConstants.OPERATIONS_CUSTOMER_BOOKINGS_MODIFY + "')")
    ...
    @PreAuthorize("hasAuthority('" + PermissionConstants.OPERATIONS_CUSTOMER_BOOKINGS_VIEW + "')")
    ...
    @PreAuthorize("hasAuthority('" + PermissionConstants.OPERATIONS_CUSTOMER_BOOKINGS_CANCEL + "')")
