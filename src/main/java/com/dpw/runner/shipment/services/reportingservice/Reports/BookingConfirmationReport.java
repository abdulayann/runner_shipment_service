...
public class BookingConfirmationReport extends IReport{
    ...
    public Map<String, Object> populateDictionary(IDocumentModel documentModel) {
        ...
        if (bookingConfirmationModel.hblModel.polName != null)
            dictionary.put(ReportConstants.PORT_OF_DEPARTURE_IN_CAPS, bookingConfirmationModel.hblModel.polName.toUpperCase());
        ...
        if (bookingConfirmationModel.hblModel.podName != null)
            dictionary.put(ReportConstants.PORT_OF_ARRIVAL_IN_CAPS, bookingConfirmationModel.hblModel.podName.toUpperCase());
