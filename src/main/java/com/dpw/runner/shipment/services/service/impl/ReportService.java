...
//        return $"{request.Scheme}://{host}{pathBase}";
    ...
    public EmailBodyResponse getPreAlertEmailTemplateData(Long shipmentId, Long emailTemplateId) throws RunnerException {
        ...
        populateTagsAndEmailTemplate(shipmentId, map, emailTemplateId, emailTemplatesRequests, toEmailIds, ccEmailIds);
    ...
    public void populateTagsAndEmailTemplate(Long shipmentId, Map<String, Object> map, Long emailTemplateId, List<EmailTemplatesRequest> emailTemplatesRequests, Set<String> to, Set<String> cc) {
        ShipmentDetails shipmentDetails = shipmentDao.findById(shipmentId)
