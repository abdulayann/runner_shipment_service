...
public class ConsolidationController {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = ConsolidationConstants.DELETE_SUCCESSFUL, content = @Content(schema = @Schema(implementation = RunnerResponse.class)))})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", content = @Content(schema = @Schema(implementation = RunnerResponse.class, description = ConsolidationConstants.RETRIEVE_BY_ID_SUCCESSFUL)))})
    @GetMapping(ConsolidationConstants.API_CONSOLIDATION_RETRIEVE_FOR_NTE_SCREEN)
    public ResponseEntity<IRunnerResponse> retrieveForNTE(@Parameter(description = ConsolidationConstants.CONSOLIDATION_ID) @RequestParam Optional<Long> id) {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", content = @Content(schema = @Schema(implementation = RunnerResponse.class, description = ConsolidationConstants.LOCK_TOGGLE_SUCCESSFUL)))})
    @GetMapping(ApiConstants.TOGGLE_LOCK)
    public ResponseEntity<IRunnerResponse> toggleLock(@Parameter(description = ShipmentConstants.CONSOLIDATION_ID, required = true) @RequestParam Long id) {
        String responseMsg;
        try {
            CommonGetRequest request = CommonGetRequest.builder().id(id).build();
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", content = @Content(schema = @Schema(implementation = RunnerResponse.class, description = ConsolidationConstants.ATTACH_SHIPMENT_SUCCESSFUL)))})
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "200", description = ConsolidationConstants.LIST_SUCCESSFUL, content = @Content(schema = @Schema(implementation = RunnerResponse.class)))})
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "200", description = ConsolidationConstants.ASSIGN_SUCCESSFUL, content = @Content(schema = @Schema(implementation = RunnerResponse.class)))})
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = ConsolidationConstants.API_GET_SUCCESSFUL, content = @Content(schema = @Schema(implementation = CustomConsolidationRequest.class))),
    })
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", content = @Content(schema = @Schema(implementation = RunnerResponse.class, description = ConsolidationConstants.IMPORT_SUCCESSFUL)))})
    @GetMapping(ConsolidationConstants.IMPORT_SHIPMENT)
    public ResponseEntity<IRunnerResponse> getShipmentFromConsol(@Parameter(description = ConsolidationConstants.CONSOLIDATION_ID, required = true) @RequestParam Long id, @RequestParam(required = false) String bookingNumber) {
        try {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", content = @Content(schema = @Schema(implementation = MblCheckResponseClass.class, description = ConsolidationConstants.MBL_NUMBER_CHECK_SUCCESSFUL)))})
    @GetMapping("/mbl-check")
    public ResponseEntity<IRunnerResponse> mblCheck(@Parameter(description = ConsolidationConstants.MBL_NUMBER, required = true) @RequestParam String mblNumber) {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", content = @Content(schema = @Schema(implementation = RunnerListResponse.class, description = "Successful Shipment Details Data List Retrieval")))})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = ContainerConstants.CALCULATION_SUCCESSFUL)})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", content = @Content(schema = @Schema(implementation = RunnerResponse.class, description = ConsolidationConstants.LIST_SUCCESSFUL)))})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = ConsolidationConstants.CREATE_SUCCESSFUL)})
    @GetMapping(ApiConstants.GET_ID_BY_GUID)
    public ResponseEntity<IRunnerResponse> getIdFromGuid(@Parameter(description = ConsolidationConstants.CONSOLIDATION_ID, required = true) @RequestParam String guid) {
        try {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", content = @Content(schema = @Schema(implementation = ValidateMawbNumberResponse.class, description = "Successful Shipment Details Data List Retrieval")))})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", content = @Content(schema = @Schema(implementation = RunnerResponse.class, description = ConsolidationConstants.CREATE_SUCCESSFUL)))})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = ConsolidationConstants.UPDATE_SUCCESSFUL, content = @Content(schema = @Schema(implementation = RunnerResponse.class)))})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", content = @Content(schema = @Schema(implementation = RunnerResponse.class, description = ConsolidationConstants.SHOW_CREATE_BOOKING_SUCCESSFUL)))})
    @GetMapping(ConsolidationConstants.API_RETRIEVE_SHOW_CREATE_BOOKING)
    public ResponseEntity<IRunnerResponse> showCreateBooking(@Parameter(description = ConsolidationConstants.SHOW_CREATE_BOOKING_OPERATION) @RequestParam String operation) throws RunnerException {
    ...
    public ResponseEntity<IRunnerResponse> getGuidFromId(@Parameter(description = ShipmentConstants.CONSOLIDATION_ID, required = true) @RequestParam Long id) {
        try {
            CommonGetRequest request = CommonGetRequest.builder().id(id).build();
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = ShipmentConstants.LIST_SUCCESSFUL, content = @Content(schema = @Schema(implementation = RunnerResponse.class)))})
