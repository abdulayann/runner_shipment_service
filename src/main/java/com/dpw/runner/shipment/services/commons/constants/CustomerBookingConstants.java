...
public class CustomerBookingConstants {
    ...
    public static final String PLATFORM_CREATE_BOOKING = "/platform-create";
    public static final String CREATE_SUCCESSFUL = "Successful Customer Booking Data Creation";
    public static final String CRP_LIST = "/crp-list";
    public static final String CRP_RETRIEVE = "/crp-retrieve";
