...
public class EVgmService implements IEVgmService{
    ...
    private final Map<String, RunnerEntityMapping> tableNames = Map.ofEntries(
            ...
            Map.entry("status", RunnerEntityMapping.builder().tableName(Constants.EVGM).dataType(BookingStatus.class).fieldName("status").build()),
    ...
    @NotNull
    private List<IRunnerResponse> convertEntityListToDtoList(@NotNull List<EVgm> lst) {
