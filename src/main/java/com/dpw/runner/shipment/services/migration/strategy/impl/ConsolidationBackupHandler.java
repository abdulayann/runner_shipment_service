...
import com.dpw.runner.shipment.services.migration.repository.interfaces.ConsolidationBackupRepository;
...
public class ConsolidationBackupHandler implements BackupHandler {
    ...
    @Autowired
    private ConsolidationBackupRepository consolidationBackupRepository;
    ...
    public void backup(Integer tenantId) {
        ...
        List<Long> consolidationIds = consolidationDetailsDao.findConsolidationIdsByTenantId(tenantId);
    ...
    public void processAndBackupConsolidation(Long consolidationId) {
        try {
            ...
            consolidationBackupData.setJsonData(response);
