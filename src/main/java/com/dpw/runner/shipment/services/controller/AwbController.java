...
import com.dpw.runner.shipment.services.commons.dto.response.AwbCalculationResponse;
import com.dpw.runner.shipment.services.commons.dto.response.AwbResponse;
import com.dpw.runner.shipment.services.commons.dto.response.FnmStatusMessageResponse;
...
public class AwbController {
    ...
    public ResponseEntity<IRunnerResponse> createAwb(@RequestBody @Valid CreateAwbRequest request) {
        String responseMsg;
        try {
            return (ResponseEntity<IRunnerResponse>) awbService.createAwb(CommonRequestModel.buildRequest(request));
        } catch (Exception e) {
    ...
    public ResponseEntity<IRunnerResponse> updateAwbDetails(@RequestBody @Valid AwbRequest request) {
        String responseMsg;
        try {
            return (ResponseEntity<IRunnerResponse>) awbService.updateAwb(CommonRequestModel.buildRequest(request));
        } catch (Exception e) {
            responseMsg = e.getMessage() != null ? e.getMessage()
    ...
    public ResponseEntity<IRunnerResponse> getChargeTypeMasterData(@ApiParam(value = AwbConstants.CHARGE_TYPE_ID, required = true) @RequestParam Long id) {
        ...
        try {
            ...
            return (ResponseEntity<IRunnerResponse>) awbService.getChargeTypeMasterData(request);
        } catch (Exception e) {
            responseMsg = e.getMessage() != null ? e.getMessage()
