...
public class OrderNumberConstants {
    ...
    public static final String ORDER_NUMBER_LIST_SUCCESSFUL = "Successful Order Number Data List Retrieval";
    public static final String ORDER_NUMBER_DELETE_SUCCESSFUL = "Successful Order Number Delete";
    public static final String ORDER_NUMBER_ID = "Order Number Id";
}
