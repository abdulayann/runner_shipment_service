...
public class CargoManifestAirShipmentReport extends IReport{
    ...
    Map<String, Object> populateDictionary(IDocumentModel documentModel) {
        ...
        dictionary = populateHAWBAndSecurityData(List.of(cargoManifestAirShipmentModel.shipmentDetails), List.of(cargoManifestAirShipmentModel.awb), dictionary, isSecurityData, false);
