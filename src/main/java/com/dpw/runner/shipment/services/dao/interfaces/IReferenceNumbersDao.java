...
public interface IReferenceNumbersDao {
    ...
    List<ReferenceNumbers> updateEntityFromConsoleWithCarrierBooking(List<ReferenceNumbers> referenceNumbersList, Long consolidationId, Long carrierBookingId) throws RunnerException;
