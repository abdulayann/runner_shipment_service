...
public class ShipmentController {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", content = @Content(schema = @Schema(implementation = HblCheckResponseClass.class)), description = ShipmentConstants.HBL_NUMBER_CHECK_SUCCESSFUL)})
    @GetMapping("/hbl-check")
    public ResponseEntity<IRunnerResponse> hblCheck(
            @Parameter(description = ShipmentConstants.HBL_NUMBER, required = true) @RequestParam String hblNumber,
            @Parameter(description = ShipmentConstants.SHIPMENT_ID, required = false) @RequestParam Optional<String> shipmentId) {
        return shipmentService.hblCheck(hblNumber, shipmentId.orElse(null));
    }

    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Successful Shipment Details Data List Retrieval", content = @Content( array = @ArraySchema(schema = @Schema(implementation = RunnerListResponse.class))))})
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = ShipmentConstants.CREATE_SUCCESSFUL, content = @Content(schema = @Schema(implementation = RunnerResponse.class))),
    ...
    // @PreAuthorize("hasAuthority('"+ Permissions.AdministrationGeneral+"')") //LATER-Authorization
    @ApiResponses(value = {@ApiResponse(responseCode = "200", content = @Content( array = @ArraySchema(schema = @Schema(implementation = RunnerListResponse.class))), description = ShipmentConstants.LIST_SUCCESSFUL)})
    ...
    public ResponseEntity<IRunnerResponse> retrieveById(@Parameter(description = ShipmentConstants.SHIPMENT_ID) @RequestParam Optional<Long> id, @Parameter(description = ShipmentConstants.SHIPMENT_GUID) @RequestParam Optional<String> guid, @RequestParam(required = false, defaultValue = "false") boolean getMasterData) {
    ...
    public ResponseEntity<IRunnerResponse> retrieveForNTE(@Parameter(description = ShipmentConstants.SHIPMENT_ID) @RequestParam Optional<Long> id, @Parameter(description = ShipmentConstants.SHIPMENT_GUID) @RequestParam Optional<String> guid) {
        CommonGetRequest request = CommonGetRequest.builder().build();
        id.ifPresent(request::setId);
        guid.ifPresent(request::setGuid);
    ...
    public ResponseEntity<IRunnerResponse> completeRetrieveById(@Parameter(description = ShipmentConstants.SHIPMENT_ID) @RequestParam Optional<Long> id, @RequestParam(name = "includeColumns", required = false) List<String> includeColumns, @Parameter(description = ShipmentConstants.SHIPMENT_GUID) @RequestParam Optional<String> guid) throws ExecutionException, InterruptedException {
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = ShipmentConstants.FETCH_ORG_INFO, content = @Content(schema = @Schema(implementation = PartiesRequest.class))),
        @ApiResponse(responseCode = "500", description = DaoConstants.DAO_GENERIC_RETRIEVE_EXCEPTION_MSG)
    })
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = ShipmentConstants.LOCK_TOGGLE_SUCCESSFUL, content = @Content(schema = @Schema(implementation = RunnerResponse.class)))})
    @GetMapping(ApiConstants.TOGGLE_LOCK)
    public ResponseEntity<IRunnerResponse> toggleLock(@Parameter(description = ShipmentConstants.SHIPMENT_ID, required = true) @RequestParam Long id) throws RunnerException {
        String responseMsg;
        try {
            CommonGetRequest request = CommonGetRequest.builder().id(id).build();
    ...
    @ApiResponses(value = { @ApiResponse(responseCode = "200", description = ShipmentConstants.ASSIGN_CONTAINERS_SUCCESSFUL, content = @Content(schema = @Schema(implementation = RunnerListResponse.class)))})
    ...
    public ResponseEntity<IRunnerResponse> cloneById(@Parameter(description = ShipmentConstants.SHIPMENT_ID, required = true) @RequestParam Long id) {
        CommonGetRequest request = CommonGetRequest.builder().id(id).build();
        return shipmentService.cloneShipment(CommonRequestModel.buildRequest(request));
    }

    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = ShipmentConstants.TI_LIST_SUCCESSFUL, content = @Content(schema = @Schema(implementation = RunnerResponse.class))),
            @ApiResponse(responseCode = "404", description = Constants.NO_DATA, content = @Content(schema = @Schema(implementation = RunnerResponse.class)))
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = ShipmentConstants.CONTAINER_LIST_SUCCESSFUL_NEW_TI),
            @ApiResponse(responseCode = "404", description = Constants.NO_DATA, content = @Content(schema = @Schema(implementation = RunnerResponse.class)))
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = ShipmentConstants.EXPORT_SUCCESSFUL),
            @ApiResponse(responseCode = "404", description = Constants.NO_DATA, content = @Content(schema = @Schema(implementation = RunnerResponse.class)))
    })
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = ShipmentConstants.RETRIEVE_BY_ORDER_ID_SUCCESSFUL, content = @Content(schema = @Schema(implementation = RunnerResponse.class)))})
    @GetMapping(ApiConstants.API_RETRIEVE_BY_ORDER_ID)
    public ResponseEntity<IRunnerResponse> retrieveByOrderId(@Parameter(description = ShipmentConstants.ORDER_ID, required = true) @RequestParam String orderId) throws RunnerException {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", content = @Content(schema = @Schema(implementation = RunnerResponse.class, description = ShipmentConstants.IMPORT_SUCCESSFUL)))})
    @GetMapping(ShipmentConstants.IMPORT_CONSOLIDATION)
    public ResponseEntity<IRunnerResponse> getConsolFromShipment(@Parameter(description = ShipmentConstants.CONSOLIDATION_ID, required = true) @RequestParam Long id) {
        try {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = ShipmentConstants.CREATE_SUCCESSFUL)})
    @GetMapping(ApiConstants.GET_ID_BY_GUID)
    public ResponseEntity<?> getIdFromGuid(@Parameter(description = ShipmentConstants.SHIPMENT_ID, required = true) @RequestParam String guid) {
        try {
    ...
    public ResponseEntity<IRunnerResponse> fetchShipmentsForConsoleId(@Parameter(description = ConsolidationConstants.CONSOLIDATION_ID, required = true) @RequestParam Long id) throws RunnerException {
        CommonGetRequest request = CommonGetRequest.builder().id(id).build();
        return shipmentService.fetchShipmentsForConsoleId(CommonRequestModel.buildRequest(request));
    }

    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Successful Active Invoices Retrieval", content = @Content(schema = @Schema(implementation = RunnerListResponse.class)))})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = ContainerConstants.SUCCESS, content = @Content(schema = @Schema(implementation = AssignAllDialogDto.class)))})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = ContainerConstants.SUCCESS, content = @Content(schema = @Schema(implementation = InvoicePostingValidationResponse.class)))})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Successful Creditn Limit Retrieval")})
    ...
    public ResponseEntity<?> getGuidFromId(@Parameter(description = ShipmentConstants.SHIPMENT_ID, required = true) @RequestParam Long id) {
        try {
            CommonGetRequest request = CommonGetRequest.builder().id(id).build();
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = ContainerConstants.SUCCESS, content = @Content(schema = @Schema(implementation = CheckCreditLimitFromV1Response.class)))})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = ContainerConstants.SUCCESS, content = @Content(schema = @Schema(implementation = UpstreamDateUpdateResponse.class)))})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = ContainerConstants.SUCCESS, content = @Content(schema = @Schema(implementation = RunnerResponse.class)))})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = ShipmentConstants.UPDATE_SHIPMENT_STATUS, content = @Content(schema = @Schema(implementation = UpstreamDateUpdateResponse.class)))})
    ...
    public ResponseEntity<IRunnerResponse> retrieveMeasurmentData(@Parameter(description = ShipmentConstants.SHIPMENT_GUID) @RequestParam Optional<String> guid, @Parameter(description = ShipmentConstants.MODULE_ID) @RequestParam Optional<String> module) {
        CommonGetRequest request = CommonGetRequest.builder().build();
        guid.ifPresent(request::setGuid);
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = ShipmentConstants.LATEST_CARGO_DELIVERY_DATE, content = @Content(schema = @Schema(implementation = UpstreamDateUpdateResponse.class)))})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = ShipmentConstants.NOTIFICATION_FETCHED_SUCCESSFULLY, content = @Content(schema = @Schema(implementation = PendingNotificationResponse.class)))})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = ShipmentConstants.FETCH_SUCCESSFUL)})
    @GetMapping(ApiConstants.API_LIST_BILL_CHARGES_SHIPMENTS)
    public ResponseEntity<?> listBillChargesShipments(@Parameter(description = ShipmentConstants.SHIPMENT_GUID, required = true) @RequestParam String guid,
    ...
    public ResponseEntity<IRunnerResponse> cancelShipment(@Parameter(description = ShipmentConstants.SHIPMENT_ID, required = true) @RequestParam Long id) throws RunnerException {
        String responseMsg;
        try {
            CommonGetRequest request = CommonGetRequest.builder().id(id).build();
    ...
    public ResponseEntity<IRunnerResponse> retrieveByIdV3(@Parameter(description = ShipmentConstants.SHIPMENT_ID) @RequestParam Optional<Long> id, @Parameter(description = ShipmentConstants.SHIPMENT_GUID) @RequestParam Optional<String> guid, @RequestParam(required = false, defaultValue = "false") boolean getMasterData) {
        CommonGetRequest request = CommonGetRequest.builder().build();
        id.ifPresent(request::setId);
        guid.ifPresent(request::setGuid);
        log.info("Received Shipment retrieve request with RequestId: {} and payload: {}", LoggerHelper.getRequestIdFromMDC(), jsonHelper.convertToJson(request));
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = ShipmentConstants.PARTY_UPDATE_SUCCESSFUL, content = @Content(schema = @Schema(implementation = RunnerResponse.class)))})
