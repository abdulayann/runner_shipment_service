...
public class PackingV3Controller {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = PackingConstants.PACKING_CREATE_SUCCESSFUL, content = @Content(schema = @Schema(implementation = MyResponseClass.class))),
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = PackingConstants.RETRIEVE_BY_ID_SUCCESSFUL, content = @Content(schema = @Schema(implementation = MyResponseClass.class)))})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = PackingConstants.PACKING_SUMMARY_SUCCESSFUL)})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = PackingConstants.MASTER_DATA_RETRIEVE_SUCCESS)})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = ASSIGN_SUCCESS, content = @Content(schema = @Schema(implementation = PackingV3Controller.ContainerResponseClass.class)))})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = UN_ASSIGN_SUCCESS, content = @Content(schema = @Schema(implementation = PackingV3Controller.ContainerResponseClass.class)))})
    ...
    public ResponseEntity<IRunnerResponse> calculateCargoSummary (@Parameter(description = Constants.SHIPMENT_ID, required = true) Long shipmentId) throws RunnerException {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = PackingConstants.ORDER_LINE_UPDATE_SUCCESSFUL, content = @Content(schema = @Schema(implementation = BulkPackingResponse.class)))})
