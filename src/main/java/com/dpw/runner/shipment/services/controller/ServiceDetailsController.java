...
public class ServiceDetailsController {
    ...
    public ResponseEntity<RunnerResponse<ServiceDetailsResponse>> createShipmentServiceData(@RequestBody @Valid ServiceDetailsRequest request) {
        String responseMsg;
        try {
            return (ResponseEntity<RunnerResponse<ServiceDetailsResponse>>) serviceDetailsService.create(CommonRequestModel.buildRequest(request));
        } catch (Exception e) {
    ...
    public ResponseEntity<RunnerResponse<ServiceDetailsResponse>> retrieveById(@ApiParam(value = ServiceDetailsConstants.SERVICE_DETAILS_ID, required = true) @RequestParam Optional<Long> id, @RequestParam Optional<String> guid) {
        CommonGetRequest request = CommonGetRequest.builder().build();
        id.ifPresent(request::setId);
        guid.ifPresent(request::setGuid);
    ...
    public ResponseEntity<RunnerResponse> update(@RequestBody @Valid ServiceDetailsRequest request) {
        String responseMsg;
        try {
            return (ResponseEntity<RunnerResponse>) serviceDetailsService.update(CommonRequestModel.buildRequest(request));
        } catch (Exception e) {
            responseMsg = e.getMessage() != null ? e.getMessage()
