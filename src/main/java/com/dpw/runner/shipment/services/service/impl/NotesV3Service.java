...
@Service
@Slf4j
public class NotesV3Service implements INotesV3Service {
        ...
        try {
            ...
            if (request.getEntityId() == null) {
                ...
                if (request.getEntityType().equalsIgnoreCase(Constants.SHIPMENT)) {
                    ...
                    ConsolidationDetailsResponse consolidationDetailsResponse = (ConsolidationDetailsResponse) ((RunnerResponse<?>) Objects.requireNonNull(
