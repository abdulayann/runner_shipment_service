...
public class EventV3Service implements IEventsV3Service {
    ...
    @Autowired
    public EventV3Service(IEventDao eventDao, JsonHelper jsonHelper, IAuditLogService auditLogService, ObjectMapper objectMapper, ModelMapper modelMapper, IShipmentDao shipmentDao
            ...
            ICarrierDetailsDao carrierDetailsDao,
...
//                     Sort groups by the latest actual date in descending order
    ...
    public ResponseEntity<IRunnerResponse> trackEvents(TrackingEventsRequest request) throws RunnerException {
        ...
        if (shipmentId != null) {
            ...
            if (trackingEventsResponse != null) {
                processTrackingEventsResponse(trackingEventsResponse, optionalShipmentDetails, shipmentId, res, entityType, identifier2ToLocationRoleMap,
                        isEmptyContainerReturnedEvent);
            }
    ...
    private void processTrackingEventsResponse(TrackingEventsResponse trackingEventsResponse, Optional<ShipmentDetails> optionalShipmentDetails, Long shipmentId,
            List<EventsResponse> res, String entityType, Map<String, EntityTransferMasterLists> identifier2ToLocationRoleMap, boolean isEmptyContainerReturnedEvent)
    ...
    private List<Events> saveTrackingEventsToEvents(List<Events> trackingEvents, String entityType,
        ...
        List<Events> updatedEvents = trackingEvents.stream()
                ...
                .map(trackingEvent -> mapToUpdatedEvent(trackingEvent, existingEventsMap, shipmentDetails.getId(), entityType, identifier2ToLocationRoleMap,
                        shipmentDetails.getShipmentId(),
