...
public class ConsolidationV3Service implements IConsolidationV3Service {
    ...
    private static final Map<String, RunnerEntityMapping> CONSOLIDATION_FIELDS = Map.ofEntries(
            ...
            Map.entry("consolidationStatus", RunnerEntityMapping.builder().tableName(Constants.CONSOLIDATION_DETAILS).dataType(ShipmentStatus.class).build())
    );
    ...
    public void beforeSave(ConsolidationDetails consolidationDetails, ConsolidationDetails oldEntity, Boolean isCreate) throws Exception {
        ...
        if (Boolean.TRUE.equals(isCreate)) {
            ...
            consolidationDetails.setConsolidationStatus(ShipmentStatus.Created);
        }
