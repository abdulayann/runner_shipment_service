...
public class ShipmentService implements IShipmentService {
    ...
    private Map<String, RunnerEntityMapping> tableNames = Map.ofEntries(
            ...
            Map.entry("hblType", RunnerEntityMapping.builder().tableName("additionalDetails").dataType(String.class).fieldName("hblType").isContainsText(true).build()),
            ...
            Map.entry("salesAgent", RunnerEntityMapping.builder().tableName("ShipmentDetails").dataType(Long.class).fieldName("salesAgent").isContainsText(true).build()),
