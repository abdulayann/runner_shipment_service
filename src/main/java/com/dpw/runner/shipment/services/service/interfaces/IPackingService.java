...
public interface IPackingService extends ICommonService {
    ...
    PackSummaryResponse calculatePacksUtilisationForConsolidation(ShipmentRequest shipmentRequest, List<Packing> packingList, Long consolidationId) throws RunnerException;
}
