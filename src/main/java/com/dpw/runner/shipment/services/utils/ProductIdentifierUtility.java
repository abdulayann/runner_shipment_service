                        ...
                        if (format.contains("L")) {
                            ...
                            if (numberOfCharactersToRetain != null) {
                                result =
                                        (result == null ? new StringBuilder("null") : result)
                                                .append(
                                                        tenantCode, 0, Math.min(numberOfCharactersToRetain, tenantCode.length()));
                            }
                        }
                    }
                    case "transportmode" -> {
                        ...
                        if (numberOfCharactersToRetain != null) {
                            result =
                                    (result == null ? new StringBuilder("null") : result)
                                            .append(
                                                    transportMode, 0, Math.min(numberOfCharactersToRetain, transportMode.length()));
                        }
                    }
                    case "date" -> result =
                            Optional.of(
