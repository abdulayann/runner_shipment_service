...
public interface IContainerV3Service {
    ...
    void saveUnAssignContainerResultsBatch(List<List<Long>> allShipmentIdsForDetachment, Map<String, List<Containers>> containersToSaveMap, List<UnAssignContainerParams> globalUnAssignContainerParams, Boolean isForcedDetach, Boolean isFCLDelete);
