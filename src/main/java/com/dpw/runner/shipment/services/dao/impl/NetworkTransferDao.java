...
public class NetworkTransferDao implements INetworkTransferDao {
    ...
    @Override
    public List<Long> findNteForMigrationStatuses(List<String> migrationStatuses, Integer tenantId) {
        return networkTransferRepository.findNteForMigrationStatuses(migrationStatuses, tenantId);
    }

    @Override
    public List<Long> findAllNteForMigrationStatuses(List<String> migrationStatuses, Integer tenantId) {
        return networkTransferRepository.findAllNteForMigrationStatuses(migrationStatuses, tenantId);
    }
