...
public class DeliveryOrderReport extends IReport{
    ...
    public Map<String, Object> populateDictionary(IDocumentModel documentModel) {
        ...
        dictionary.put(ReportConstants.NET_WEIGHT1, ConvertToWeightNumberFormat(deliveryOrderModel.shipmentDetails.getNetWeight(), v1TenantSettingsResponse));
        if(deliveryOrderModel.getContainers() != null && deliveryOrderModel.getContainers().size() > 0) {
            ...
            for (Map<String, Object> v : valuesContainer) {
                ...
                if (v.containsKey(ReportConstants.NET_WEIGHT1) && v.get(ReportConstants.NET_WEIGHT1) != null)
                    v.put(ReportConstants.NET_WEIGHT1, ConvertToWeightNumberFormat(v.get(ReportConstants.NET_WEIGHT1), v1TenantSettingsResponse));
            }
