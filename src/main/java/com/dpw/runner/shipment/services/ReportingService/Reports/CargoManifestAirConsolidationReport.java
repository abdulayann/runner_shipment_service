...
public class CargoManifestAirConsolidationReport extends IReport{
    ...
    Map<String, Object> populateDictionary(IDocumentModel documentModel) {
        ...
        dictionary = populateHAWBAndSecurityData(cargoManifestAirConsolidationModel.shipmentModelList, cargoManifestAirConsolidationModel.awbList, dictionary, isSecurityData, true);
