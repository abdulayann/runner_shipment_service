...
public class RoutingsService implements IRoutingsService {
    ...
    public ResponseEntity<?> create(CommonRequestModel commonRequestModel) {
        ...
        Routings routing = convertRequestToRoutingsEntity(request);
        routing = routingsDao.save(routing);
        return ResponseHelper.buildSuccessResponse(convertEntityToDto(routing));
    }
    ...
    public ResponseEntity<?> update(CommonRequestModel commonRequestModel) {
        ...
        Routings routing = convertRequestToRoutingsEntity(request);
        routing.setId(oldEntity.get().getId());
        routing = routingsDao.save(routing);
        return ResponseHelper.buildSuccessResponse(convertEntityToDto(routing));
    }
    ...
    public ResponseEntity<?> delete(CommonRequestModel commonRequestModel) {
        ...
        try {
            ...
            long id = request.getId();
            Optional<Routings> routing = routingsDao.findById(id);
            if (routing.isEmpty()) {
                log.debug("Routings is null for Id {}", request.getId());
                throw new DataRetrievalFailureException(DaoConstants.DAO_DATA_RETRIEVAL_FAILURE);
            }
    ...
    public ResponseEntity<?> retrieveById(CommonRequestModel commonRequestModel) {
        ...
        try {
            ...
            RoutingsResponse response = convertEntityToDto(routings.get());
