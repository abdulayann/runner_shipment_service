...
public class SectionDetailsServiceImpl implements ISectionDetailsService {
    ...
    private final ISectionVisibilityRepository sectionVisibilityRepository;
    private final ModelMapper modelMapper;

    public SectionDetailsServiceImpl(ISectionDetailsRepository sectionDetailsRepository,
                                     ISectionFieldsRepository sectionFieldsRepository, ISectionVisibilityRepository sectionVisibilityRepository, ModelMapper modelMapper) {
        this.sectionDetailsRepository = sectionDetailsRepository;
        this.sectionFieldsRepository = sectionFieldsRepository;
        this.sectionVisibilityRepository = sectionVisibilityRepository;
    ...
    public IRunnerResponse delete(Long id) {
        ...
        List<SectionVisibility> sectionVisibilities = sectionVisibilityRepository.findBySectionDetailsId(id);
        if (!CollectionUtils.isEmpty(sectionVisibilities)) {
