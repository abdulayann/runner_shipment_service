...
//                        .chargable(shipment.getChargable())
    ...
    public Boolean validateCarrierDetails(ConsolidationDetails consolidation, Boolean validPrinting, List<String> failureReasons) {
        if (ObjectUtils.isEmpty(consolidation.getCarrierDetails())) {
            validPrinting = Boolean.FALSE;
        ...
        return validPrinting;
    }

    public Boolean validateContainerDetails(ConsolidationDetails consolidation, Boolean validPrinting, List<String> failureReasons) {
