...
public class TenantAspect {
    ...
    public void beforeFindOfMultiTenancyRepository(JoinPoint joinPoint) {
        ...
        else if (!permissions.containsKey(PermissionConstants.TENANT_SUPER_ADMIN) && !permissions.containsKey(PermissionConstants.CROSS_TENANT_LIST) && !permissions.containsKey(PermissionConstants.CROSS_TENANT_RETRIEVE_PERMISSION) && !permissions.containsKey(PermissionConstants.COMPANY_SUPER_ADMIN)) {
            entityManager.unwrap(Session.class)
