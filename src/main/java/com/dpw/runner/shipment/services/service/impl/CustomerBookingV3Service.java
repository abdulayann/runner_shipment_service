...
import static com.dpw.runner.shipment.services.commons.constants.Constants.DIRECTION;
...
import static com.dpw.runner.shipment.services.commons.constants.Constants.SERVICE_MODE;
import static com.dpw.runner.shipment.services.commons.constants.Constants.SHIPMENT;
import static com.dpw.runner.shipment.services.commons.constants.Constants.TESLA;
...
public class CustomerBookingV3Service implements ICustomerBookingV3Service {
    ...
    private Map<String, RunnerEntityMapping> tableNames = Map.ofEntries(
            ...
            Map.entry("contractId", RunnerEntityMapping.builder().tableName(Constants.CUSTOMER_BOOKING).dataType(String.class).fieldName("contractId").isContainsText(true).build()),
            Map.entry("parentContractId", RunnerEntityMapping.builder().tableName(Constants.CUSTOMER_BOOKING).dataType(String.class).fieldName("parentContractId").isContainsText(true).build()),
