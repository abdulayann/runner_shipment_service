...
public class BookingIntegrationsUtility {
    ...
    private void setAddressDataInPartiesRequest(String partyType, Map<String, PartiesRequest> requestMap, Map addressRow, PartiesRequest party) {
        if(addressRow.containsKey("OrgId") && addressRow.get("OrgId").equals(party.getOrgId()) &&
                requestMap.containsKey(partyType) && requestMap.get(partyType).getAddressCode().equals(addressRow.get("AddressShortCode"))) {
    ...
    public void transformOrgAndAddressPayloadToGivenParties(Map<String, PartiesRequest> requestMap) {
        ...
        try {
            ...
            CommonV1ListRequest orgRequest = createCriteriaForTwoFields("OrganizationCode", "in", orgCodes, "ActiveClient", "=", Boolean.TRUE);
            ...
            CommonV1ListRequest addressRequest = createCriteriaForThreeFields(
                    "OrgId", "in", orgIds,
                    "AddressShortCode", "in", addressCodes,
                    "Active", "=", Boolean.TRUE);
