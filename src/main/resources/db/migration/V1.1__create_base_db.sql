...
alter table shipment_details
    add column bl_detail_id bigint unique;
ALTER TABLE shipment_details
    ADD CONSTRAINT FK_bl_shipment FOREIGN KEY (bl_detail_id) REFERENCES bl_details (id);
alter table shipment_details
    add column carrier_detail_id bigint unique;
ALTER TABLE shipment_details
    ADD CONSTRAINT FK_carrier_shipment FOREIGN KEY (carrier_detail_id) REFERENCES carrier_details (id);
alter table shipment_details
    add column measurement_detail_id bigint unique;
ALTER TABLE shipment_details
    ADD CONSTRAINT FK_meaurment_shipment FOREIGN KEY (measurement_detail_id) REFERENCES measurment_details (id);
alter table shipment_details
    add column pickup_detail_id bigint unique;
ALTER TABLE shipment_details
    ADD CONSTRAINT FK_pickup_shipment FOREIGN KEY (pickup_detail_id) REFERENCES pickup (id);
alter table shipment_details
    add column delivery_detail_id bigint unique;
ALTER TABLE shipment_details
    ADD CONSTRAINT FK_delivery_shipment FOREIGN KEY (delivery_detail_id) REFERENCES delivery (id);
alter table shipment_details
    add column assigned_to int;
alter table shipment_details
    add column is_domestic boolean default false;
alter table shipment_details
    add column shipment_id varchar;

alter table consolidation_details
    add column carrier_id bigint unique;
ALTER TABLE consolidation_details
    ADD CONSTRAINT FK_carrier_console FOREIGN KEY (carrier_id) REFERENCES carrier_details (id);
alter table consolidation_details
    add column achieved_quantity_id bigint unique;
ALTER TABLE consolidation_details
    ADD CONSTRAINT FK_archieved_quantity_console FOREIGN KEY (achieved_quantity_id) REFERENCES achieved_quantities (id);
alter table consolidation_details
    add column departure_id bigint unique;
ALTER TABLE consolidation_details
    ADD CONSTRAINT FK_departure_console FOREIGN KEY (departure_id) REFERENCES departure (id);
alter table consolidation_details
    add column arrival_id bigint unique;
ALTER TABLE consolidation_details
    ADD CONSTRAINT FK_arrival_console FOREIGN KEY (arrival_id) REFERENCES arrival (id);
alter table consolidation_details
    add column mbl_detail_id bigint unique;
ALTER TABLE consolidation_details
    ADD CONSTRAINT FK_mbl_details_console FOREIGN KEY (mbl_detail_id) REFERENCES mbl_details (id);
alter table consolidation_details
    add column allocation_id bigint unique;
ALTER TABLE consolidation_details
    ADD CONSTRAINT FK_allocations_console FOREIGN KEY (allocation_id) REFERENCES allocations (id);
alter table consolidation_details
    add column cutoff_id bigint unique;
ALTER TABLE consolidation_details
    ADD CONSTRAINT FK_cutoffs_console FOREIGN KEY (cutoff_id) REFERENCES cutoffs (id);
