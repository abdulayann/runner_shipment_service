...
CREATE TABLE IF NOT EXISTS public.shipment_setting
(
...
CREATE TABLE IF NOT EXISTS public.pickup_delivery_details
(
    id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    created_at timestamp without time zone NOT NULL,
    created_by integer,
    ...
    updated_by integer,
    tenant_id integer,
    actual_pickup_or_delivery timestamp without time zone,
    estimated_pickup_or_delivery timestamp without time zone,
    pickup_or_delivery timestamp without time zone,
    port_transport_advised timestamp without time zone,
    required_by timestamp without time zone,
    shipment_id bigint,
