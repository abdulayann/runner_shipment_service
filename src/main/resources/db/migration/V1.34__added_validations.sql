...
VALUES (NOW(), 1, uuid_generate_v4(), NOW(), 1, 1, 'BOOKING',
        '{"properties":{"bookingStatus":{"required ":true,"enum":["PENDING_FOR_KYC","PENDING_FOR_CREDIT_LIMIT","READY_FOR_SHIPMENT","CANCELLED"]},"bookingNumber":{"required ":true},"bookingDate":{"required ":true}}}',
        'ON_CREATE')
