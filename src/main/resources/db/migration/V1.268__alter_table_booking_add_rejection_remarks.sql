CREATE INDEX IF NOT EXISTS idx_event_entity_id ON events(entity_id);
CREATE INDEX IF NOT EXISTS idx_event_entity_type ON events(entity_type);
CREATE INDEX IF NOT EXISTS idx_event_entity_id_type ON events(entity_id, entity_type);
