drop table if exists ti_truck_driver_details;
drop table if exists ti_containers;
drop table if exists ti_packages;
drop table if exists ti_reference;
drop table if exists ti_legs;
...
CREATE TABLE ti_legs (
    ...
    drop_mode varchar,
    remarks varchar,
    pickup_delivery_details_id bigint,
    FOREIGN KEY (pickup_delivery_details_id) REFERENCES pickup_delivery_details(id),
    CONSTRAINT ti_legs_origin_id FOREIGN KEY (origin_id) REFERENCES parties(id),
    CONSTRAINT ti_legs_destination_id FOREIGN KEY (destination_id) REFERENCES parties(id)
);
