...
public class ConsolidationController {
    ...
    public ResponseEntity<IRunnerResponse> createFromBooking(@RequestBody ConsolidationDetailsRequest consolidationDetailsRequest) throws RunnerException {

        String responseMsg;
        try {
            CommonRequestModel commonRequestModel = CommonRequestModel.buildRequest(consolidationDetailsRequest);
            ConsolidationDetailsResponse consolidationResponse =  consolidationService.createConsolidationForBooking(commonRequestModel);
            String response = jsonHelper.convertToJson(consolidationResponse);
