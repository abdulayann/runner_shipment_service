...
public class ServiceDetailsConstants {
    ...
    public static final String SERVICE_DETAILS_LIST_SUCCESSFUL = "Successful Service Details List Retrieval";

    public static final String SERVICE_DETAILS_DELETE_SUCCESSFUL = "Successful Service Details Delete";

    public static final String SERVICE_DETAILS_RETRIEVE_BY_ID_SUCCESSFUL = "Successful Service Details Data Retrieval By Id";
